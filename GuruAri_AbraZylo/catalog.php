<?php
// =============================================================================
// SERVER FILE PATH: /home/royaldxd/abra-zylo.com/catalog/model/wkrestapi/catalog.php
// UPLOAD THIS FILE TO THE ABOVE PATH ON THE SERVER TO APPLY THE FIX
// =============================================================================
...
AND pd.language_id= '" . $language_id['id'] . "'";
	...
	public function getDominantColor($filePath)
	{
		...
		// FIX: imagesx() requires a valid GD image resource.
		// If $image is empty (unsupported file type or failed to load), return black as default color.
		if (!$image) {
				...
				foreach ($filter_groups as $filter_group) {
					...
					foreach ($filter_group['filter'] as $filter) {
						...
						$childen_data[] = array(
							...
							'name'      => $filter['name'] . $this->config->get('config_product_count')
						);
					}
