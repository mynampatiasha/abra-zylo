...
/// bottom sheet that obscures the content behind it when a user taps a labelLarge.
/// It also demonstrates how to close the bottom sheet using the [Navigator]
/// when a user taps on a labelLarge inside the bottom sheet.
///
...
/// [ModalRoute] and a back labelLarge is added to the app bar of the [Scaffold]
/// that closes the bottom sheet.
///
/// To create a persistent bottom sheet that is not a [LocalHistoryEntry] and
/// does not add a back labelLarge to the enclosing Scaffold's app bar, use the
/// [Scaffold.bottomSheet] constructor parameter.
///
