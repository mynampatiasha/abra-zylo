...
import 'package:oc_demo/screens/add_edit_address/bloc/add_edit_address_repository.dart';
    ...
    switch (event.runtimeType) {
      ...
      case AddressDetailFetchEvent:
        try {
          var model = await repository
              ?.getAddressDetails((event as AddressDetailFetchEvent).addressId);
          if (model != null) {
      ...
      case AddAddressEvent:
        try {
          ...
          var model = await repository?.addNewAddress(event.addAddressRequest);
          if (model != null) {
