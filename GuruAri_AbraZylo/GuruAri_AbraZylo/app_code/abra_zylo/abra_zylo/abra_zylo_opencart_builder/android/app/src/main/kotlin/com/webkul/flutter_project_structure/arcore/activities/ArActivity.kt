...
import webkul.opencart_flutter.mobikul.databinding.ActivityArBinding
...
//            "https://oc.webkul.com/mobikul/hyperlocal/index.php?route=api/wkrestapi/catalog/arProduct&product_id=681"
    ...
    private fun startInitialization() {
        mContentViewBinding.progressCircular.visibility=View.VISIBLE
        try {
    ...
    private fun hasRequiredStoragePermission(): Boolean {
        // Android 10+ uses scoped storage; requesting legacy storage there can never unblock AR startup.
